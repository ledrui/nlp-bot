export declare namespace FrenchNumeric {
    ...
    const TenToNineteenIntegerRegex = "(dix[-\\s]neuf|dix[-\\s]huit|dix[-\\s]sept|(-)?seize|(-)?quinze|(-)?quatorze|(-)?treize|(-)?douze|(-)?onze|dix)";
    const TensNumberIntegerRegex = "(quatre[-\\s]vingt[-\\s]dix|quatre[-\\s]vingt(s)?|soixante[-\\s]dix|vingt|trente|quarante|cinquante|soixante|septante|octante|huitante|nonante)";
