...
(_build2.default)(_xregexp2.default);
(_matchrecursive2.default)(_xregexp2.default);
(_unicodeBase2.default)(_xregexp2.default);
(_unicodeBlocks2.default)(_xregexp2.default);
(_unicodeCategories2.default)(_xregexp2.default);
(_unicodeProperties2.default)(_xregexp2.default);
(_unicodeScripts2.default)(_xregexp2.default);
...
class JapaneseBooleanExtractorConfiguration {
    constructor(onlyTopMatch = true) {
        this.regexTrue = recognizersText.RegExpUtility.getSafeRegExp(japaneseChoice.JapaneseChoice.TrueRegex);
        this.regexFalse = recognizersText.RegExpUtility.getSafeRegExp(japaneseChoice.JapaneseChoice.FalseRegex);
        this.tokenRegex = recognizersText.RegExpUtility.getSafeRegExp(japaneseChoice.JapaneseChoice.TokenizerRegex, 'is');
        this.onlyTopMatch = onlyTopMatch;
    }
}
...
})(PortugueseChoice = exports.PortugueseChoice || (exports.PortugueseChoice = {}));
...
class PortugueseBooleanExtractorConfiguration {
    constructor(onlyTopMatch = true) {
        this.regexTrue = recognizersText.RegExpUtility.getSafeRegExp(portugueseChoice.PortugueseChoice.TrueRegex);
        this.regexFalse = recognizersText.RegExpUtility.getSafeRegExp(portugueseChoice.PortugueseChoice.FalseRegex);
        this.tokenRegex = recognizersText.RegExpUtility.getSafeRegExp(portugueseChoice.PortugueseChoice.TokenizerRegex, 'is');
        this.onlyTopMatch = onlyTopMatch;
    }
}
...
(function (SpanishChoice) {
    ...
    SpanishChoice.TokenizerRegex = `[^\\w\\d\\u00E0-\\u00FF]`;
...
class SpanishBooleanExtractorConfiguration {
    constructor(onlyTopMatch = true) {
        this.regexTrue = recognizersText.RegExpUtility.getSafeRegExp(spanishChoice.SpanishChoice.TrueRegex);
        this.regexFalse = recognizersText.RegExpUtility.getSafeRegExp(spanishChoice.SpanishChoice.FalseRegex);
        this.tokenRegex = recognizersText.RegExpUtility.getSafeRegExp(spanishChoice.SpanishChoice.TokenizerRegex, 'is');
        this.onlyTopMatch = onlyTopMatch;
    }
}
...
(function (ChineseChoice) {
    ...
    ChineseChoice.TrueRegex = `(好[的啊呀嘞哇]|没问题|可以|中|好|同意|同意|行|是的|是|对)|(\\uD83D\\uDC4D|\\uD83D\\uDC4C)`;
...
class ChineseBooleanExtractorConfiguration {
    constructor(onlyTopMatch = true) {
        this.regexTrue = recognizersText.RegExpUtility.getSafeRegExp(chineseChoice.ChineseChoice.TrueRegex);
        this.regexFalse = recognizersText.RegExpUtility.getSafeRegExp(chineseChoice.ChineseChoice.FalseRegex);
        this.tokenRegex = recognizersText.RegExpUtility.getSafeRegExp(chineseChoice.ChineseChoice.TokenizerRegex, 'is');
        this.onlyTopMatch = onlyTopMatch;
    }
}
...
class ChoiceRecognizer extends recognizersText.Recognizer {
    ...
    InitializeConfiguration() {
        ...
        //#endregion
        //#region Japanese
        this.registerModel("BooleanModel", recognizersText.Culture.Japanese, (options) => new models$2.BooleanModel(new parsers$2.BooleanParser(), new extractors$2.BooleanExtractor(new boolean_1$1.JapaneseBooleanExtractorConfiguration())));
        //#endregion
        //#region Portuguese
        this.registerModel("BooleanModel", recognizersText.Culture.Portuguese, (options) => new models$2.BooleanModel(new parsers$2.BooleanParser(), new extractors$2.BooleanExtractor(new boolean_1$2.PortugueseBooleanExtractorConfiguration())));
        //#endregion
        //#region Spanish
        this.registerModel("BooleanModel", recognizersText.Culture.Spanish, (options) => new models$2.BooleanModel(new parsers$2.BooleanParser(), new extractors$2.BooleanExtractor(new boolean_1$3.SpanishBooleanExtractorConfiguration())));
        //#endregion
        //#region Chinese
        this.registerModel("BooleanModel", recognizersText.Culture.Chinese, (options) => new models$2.BooleanModel(new parsers$2.BooleanParser(), new extractors$2.BooleanExtractor(new boolean_1$4.ChineseBooleanExtractorConfiguration())));
        //#endregion
    }
...
exports.PortugueseBooleanExtractorConfiguration = boolean_1$2.PortugueseBooleanExtractorConfiguration;

exports.JapaneseBooleanExtractorConfiguration = boolean_1$1.JapaneseBooleanExtractorConfiguration;

exports.SpanishBooleanExtractorConfiguration = boolean_1$3.SpanishBooleanExtractorConfiguration;

exports.ChineseBooleanExtractorConfiguration = boolean_1$4.ChineseBooleanExtractorConfiguration;
...
var recognizersTextChoice_13 = recognizersTextChoice.PortugueseBooleanExtractorConfiguration;
var recognizersTextChoice_14 = recognizersTextChoice.JapaneseBooleanExtractorConfiguration;
var recognizersTextChoice_15 = recognizersTextChoice.SpanishBooleanExtractorConfiguration;
var recognizersTextChoice_16 = recognizersTextChoice.ChineseBooleanExtractorConfiguration;
var recognizersTextChoice_17 = recognizersTextChoice.EnglishChoice;
var recognizersTextChoice_18 = recognizersTextChoice.PortugueseChoice;
var recognizersTextChoice_19 = recognizersTextChoice.JapaneseChoice;
var recognizersTextChoice_20 = recognizersTextChoice.SpanishChoice;
var recognizersTextChoice_21 = recognizersTextChoice.ChineseChoice;

export { recognizersTextChoice_1 as ChoiceRecognizer, recognizersTextChoice_2 as ChoiceOptions, recognizersTextChoice_3 as recognizeBoolean, recognizersTextChoice_4 as Culture, recognizersTextChoice_5 as Constants, recognizersTextChoice_6 as ChoiceModel, recognizersTextChoice_7 as BooleanModel, recognizersTextChoice_8 as ChoiceExtractor, recognizersTextChoice_9 as BooleanExtractor, recognizersTextChoice_10 as ChoiceParser, recognizersTextChoice_11 as BooleanParser, recognizersTextChoice_12 as EnglishBooleanExtractorConfiguration, recognizersTextChoice_13 as PortugueseBooleanExtractorConfiguration, recognizersTextChoice_14 as JapaneseBooleanExtractorConfiguration, recognizersTextChoice_15 as SpanishBooleanExtractorConfiguration, recognizersTextChoice_16 as ChineseBooleanExtractorConfiguration, recognizersTextChoice_17 as EnglishChoice, recognizersTextChoice_18 as PortugueseChoice, recognizersTextChoice_19 as JapaneseChoice, recognizersTextChoice_20 as SpanishChoice, recognizersTextChoice_21 as ChineseChoice };
